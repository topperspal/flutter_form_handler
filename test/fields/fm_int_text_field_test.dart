...
void main() {
  group('FmIntTextField Unit Test :', () {
    ...
    test('If value is required and it is null, error should be "Required"', () async {
      final field = FmIntTextField(required: true);
      expect(field.value, null);
      expect(field.error, "Required");

      await field.dispose();

      final field2 = FmIntTextField(value: 1, required: true);
